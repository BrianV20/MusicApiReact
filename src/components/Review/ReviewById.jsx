  ...
  return (
    <>
      ...
      <div className="bg-slate-200">
        <div className="md:w-[80%] lg:w-[70%] min-h-screen mx-auto">
          <div className="flex text-slate-500 p-5">
            <div className="w-[55%]">
              <div className="mb-1 flex" onClick={handleUserReviewClick}>
                ...
                />
                <p className="text-[0.8rem] self-center ml-2 md:text-2xl lg:hover:cursor-pointer lg:hover:text-slate-400 lg:transition-all lg:duration-200 lg:ease-in-out">{user.username}</p>
                {/* </Link> */}
              </div>
              <div className="mb-1">
            ...
            <div className="w-[45%]">
              ...
              >
                <img
                  className="border-2 border-slate-400 h-full max-h-[8rem] md:w-[17rem] md:min-h-[17rem] lg:hover:opacity-70 lg:transition-all lg:ease-in lg:duration-200"
                  src={release.cover}
                  alt={release.title}
                />
              </Link>
