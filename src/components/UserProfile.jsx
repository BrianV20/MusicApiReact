...
export default function UserProfile() {
    ...
    return (
        <div className="bg-pink-200 w-full">
            <img className="w-[40%] mx-auto rounded-full py-2" src="https://a.ltrbxd.com/resized/avatar/upload/5/1/4/2/9/7/7/shard/avtr-0-1000-0-1000-crop.jpg?v=8654e435ae" alt="" />
            <h1>Username</h1>
